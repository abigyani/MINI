...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            db.execSQL("create table speech(key varchar(20),answer varchar(20))");
        ...
        switch (requestCode){
            case 100 : if(resultCode==RESULT_OK && intent!=null) {
                ...
                if (check.contains("class") || check.contains("glass")) {
                    ...
                    try {
                        Cursor c = db.rawQuery("select answer from speech where key = '" + check + "'", null);
                        c.moveToNext();
            ...
            case 103 : if(resultCode==RESULT_OK && intent!=null) {
                ...
                if(check102.contains("ye")){
                    try{
                        db.execSQL("insert into speech values('"+temp+"','"+temp2+"')");
